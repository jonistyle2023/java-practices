public class EjemploStringMetodos {
    public static void main(String[] args) {
        ...
        System.out.println("nombre.equals(\"jonathan\") = " + nombre.equals("jonathan"));
        System.out.println("nombre.equalsIgnoreCase(\"jonathan\") = " + nombre.equalsIgnoreCase("jonathan"));
        System.out.println("nombre.compareTo(\"Jonathan\") = " + nombre.compareTo("Jonathan"));
